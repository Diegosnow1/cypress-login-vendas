...
1 - quando forem homologar qualquer coisas, sempre inserir um "produto fora de estoque", "madeira" e "tinta", porque as 
   ...
   (CT01)Fluxo  Venda completa produto fora de estoque
  

 * RESULTADO ESPERADO:

 * CASO DE TESTE (CT01): Pedido com produto fora de estoque, o sistema deve finalizar o orçamento com a situação de (apenas orçando) e sem erros.
 * 
